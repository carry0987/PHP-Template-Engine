...
CREATE TABLE IF NOT EXISTS template (
  ...
  tpl_path varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  tpl_name varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  tpl_type varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  tpl_md5 varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  tpl_expire_time int(20) COLLATE utf8mb4_unicode_ci NOT NULL,
